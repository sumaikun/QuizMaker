...
<html lang="en">
  ...
  <body>
   ...
   <div class="container">
    <form method="post" action="<?php echo $helper->url("Index","begin"); ?>"> 
      <div class="starter-template">
      <h1>Ingrese su cedula o codigo de identificación</h1>
      <p class="lead"></p>
      <input type="text" class="form-control" name="iden_code" id="iden_code">
      </div>
      <input type="submit" value="Enviar" class="btn btn-warning form-control">
    </form>
